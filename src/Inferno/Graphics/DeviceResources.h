...
namespace Inferno {
    ...
    public:
        ...
        Inferno::ColorBuffer FogDepthBuffer, MsaaFogDepthBuffer;
        ...
        Inferno::ColorBuffer& GetFogDepthBuffer() {
            return Settings::Graphics.MsaaSamples > 1 ? MsaaFogDepthBuffer : FogDepthBuffer;
        }
