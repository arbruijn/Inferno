...
namespace Inferno {
    ...
    struct GraphicsSettings {
        ...
        bool EnableHDR = false; // Enables HDR-capable swap chain output when supported by the current display
        ...
        float Brightness = 1;
        float HDRPaperWhiteNits = 200.0f; // Diffuse white level for SDR UI/content on HDR displays
